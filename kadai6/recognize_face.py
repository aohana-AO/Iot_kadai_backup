...
#内容は自身の顔、AImodel女性の顔、大泉洋の顔三つで学習
...
def main():
    ...
    for c in os.listdir('C:/Users/kbc21a34/OneDrive - kawahara.ac.jp/Python/IoT_conda/Raspi_kinoko_takenoko/data/train'):  # フルパスに修正必要
        print('class: {}, class id: {}'.format(c, label))
        d = os.path.join('C:/Users/kbc21a34/OneDrive - kawahara.ac.jp/Python/IoT_conda/Raspi_kinoko_takenoko/data/train', c)  # フルパスに修正必要/home/yamashita/Raspi_kinoko_takenoko/data/train
        imgs = os.listdir(d)
